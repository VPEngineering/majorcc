...
<?php
		if (isset($_POST["user_edit_save"])) {
			...
			$user_update["notification"] = $_POST["notification"];
			$user_update["notification_id"] = $_POST["notification_id"];
			$user_update["notification_closed"] = $_POST["notification_closed"];
			$user_update["notification_processed"] = $_POST["notification_processed"];
			if ($_POST["user_pass"] != "") {
				switch (passwordFaild($_POST["user_pass"], $_POST["user_pass"])) {
					case 0:
						$errorMsg = "";
...
?>
										...
										<td class="centered">
											<span><input class="formstyle" name="notification" type="text" value="<?=$value['notification']?>" /></span>
										</td>
										<td class="centered">
											<span><input class="formstyle" name="notification_id" type="text" value="<?=$value['notification_id']?>" /></span>
										</td>
										<td class="centered">
											<span><input class="formstyle" name="notification_closed" type="text" value="<?=$value['notification_closed']?>" /></span>
										</td>
										<td class="centered">
											<span><input class="formstyle" name="notification_processed" type="text" value="<?=$value['notification_processed']?>" /></span>
										</td>
									</tr>
									<tr>
										<td colspan="7" class="centered">
