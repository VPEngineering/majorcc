...
define('DB_SERVER', "mysql5033.site4now.net");
define('DB_DATABASE', "db_a7c06b_majorcc");
define('DB_USER', "a7c06b_majorcc");
define('DB_PASS', "miglior456cc");
...
function stringEnc($string){
    ...
    $options = 0;
    $encryption_iv = '8334957821811121';
    $encryption_key = "vampirevhc";
...
function stringDec($string){
    ...
    $iv_length = openssl_cipher_iv_length($ciphering);
    $options = 0;
    $decryption_iv = '8334957821811121';
    $decryption_key = "vampirevhc";
    $decryption = openssl_decrypt ($string, $ciphering, $decryption_key, $options, $decryption_iv);
    
    return $decryption;
}

function getUserData($id, $type, $conn){
    
	$userinfo = mysqli_query($conn, "SELECT * FROM users WHERE `user_id`='$id';");
